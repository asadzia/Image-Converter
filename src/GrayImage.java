...
public class GrayImage 
{
	...
	public static String processFileExtension (File file)
	{
		...
		{	
			/* this will give a null pointer exception which is caught */
			return null;
		}
	}
	 ...
	 */
	public static void Run_Gray () throws IOException, SecurityException, NullPointerException
	{
		try 
		{
			...
			{
				File theDir = new File("Gray-Images");

				// if the directory does not exist, create it
				if (!theDir.exists()) 
				{
				    System.out.println("Creating directory: " + "Gray-Images");
